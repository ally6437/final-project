...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference("Province.count") do
      post provinces_url, params: { province: { name: @province.name, tax_rate: @province.tax_rate } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { name: @province.name, tax_rate: @province.tax_rate } }
